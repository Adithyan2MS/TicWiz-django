...
from BackendApp.models import EventCategoryDB,SubeventDb,MovieDB,Bookingdb,DetailsDb
...
def detailed(request,det):
    ...
    return render(request,"seperate.html",{"det_data":det_data})
...
def seatconfirm(request):
    ...
    if request.method=="POST":
        ...
        obj=Bookingdb(Name=na,Seat=sc,Movie=mo,Screen=sn,Time=ti,Date=dt)
        obj.save()
